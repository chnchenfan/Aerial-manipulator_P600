...
![mode1 / exp1 悬停扰动实验实飞可视化](docs/media/p600_mode1_exp1_hover_disturbance.gif)
...
![mode2 / exp3 方形轨迹跟踪实验实飞可视化](docs/media/p600_mode2_exp3_square_trajectory_tracking.gif)
